export default function App() {
  return (
    <div className="h-screen w-screen bg-[#040039] flex items-center justify-center">
      ...
      <div className="absolute h-5/6 w-3/4 max-w-3xl bg-[#000625] bg-opacity-50 rounded-xl border border-white flex flex-col items-center justify-center text-white">
        ...
        <button className="w-1/2 h-16 mt-10 rounded text-2xl font-light bg-gradient-to-r from-[#AC1C1C] to-[#003089] flex items-center justify-center gap-2">
          Join a Random Room
          <span className="h-8 aspect-square bg-contain bg-no-repeat bg-[url('/shuffle.svg')]" />
        </button>
        <div className="w-1/2 mt-6 flex flex-row gap-2">
        ...
        <button className="w-1/2 h-16 mt-6 rounded text-2xl font-light bg-[#595858] flex items-center justify-center gap-2">
          How to Play
